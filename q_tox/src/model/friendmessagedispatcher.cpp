...
{
    qDebug() << "002------------------FriendMessageDispatcher::sendMessageToCore-----------------start" ;
    ...
    qDebug() << "002------------------FriendMessageDispatcher::sendMessageToCore-----------------end" ;
...
{
    qDebug() << "connect------------------FriendMessageDispatcher::FriendMessageDispatcher-----------------start" ;
    connect(&f, &Friend::onlineOfflineChanged, this, &FriendMessageDispatcher::onFriendOnlineOfflineChanged);
    qDebug() << "connect------------------FriendMessageDispatcher::FriendMessageDispatcher-----------------end" ;
}
...
{
    qDebug() << "001------------------FriendMessageDispatcher::sendMessage-----------------start" ;
    ...
    qDebug() << "001------------------FriendMessageDispatcher::sendMessage-----------------end" ;
...
{
    qDebug() << "-005--------FriendMessageDispatcher::onFriendOnlineOfflineChanged---------start" ;
    if (isOnline) {
        offlineMsgEngine.deliverOfflineMsgs();
    }
    qDebug() << "-005--------FriendMessageDispatcher::onFriendOnlineOfflineChanged---------end" ;
}
