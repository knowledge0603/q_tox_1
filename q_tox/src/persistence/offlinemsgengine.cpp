...
{
    qDebug() << "-006--------OfflineMsgEngine::deliverOfflineMsgs---------start" ;
    QMutexLocker ml(&mutex);
    qDebug() << "-006--01" ;
    ...
    for (const auto& message : messages) {
        qDebug() << "-007--------OfflineMsgEngine::deliverOfflineMsgs messgae---------start" ;
        ...
        qDebug() << "-007--------OfflineMsgEngine::deliverOfflineMsgs message---------start" ;
    }
    qDebug() << "-006--------OfflineMsgEngine::deliverOfflineMsgs ---------end" ;
}
