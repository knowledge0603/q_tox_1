...
{
    qDebug() << QString("--1001--GenericChatForm::onSendTriggered--start");
    ...
    qDebug() << QString("--1001--GenericChatForm::onSendTriggered--end");
}
...
{
    sendButton->setToolTip(tr("modify bu grj Send message"));
