...
#include "src/widget/form/viewpersonalhtmldialog.h"
...
void Widget::init()
{
    ...
    connect(ui->viewPersonalHtmlButton, &QPushButton::clicked, this, &Widget::on_viewPersonalHtmlButton_clicked);
...
{
    qDebug() << "------widget.cpp--start-20191224-----onFriendRequestReceived---------------";
    if (addFriendForm->addFriendRequest(friendPk.toString(), message)) {
        friendRequestsUpdate();
        qDebug() << "------widget.cpp-------onFriendRequestReceived--friendRequestsUpdate-------------";
    ...
    qDebug() << "------widget.cpp--end-20191224-----onFriendRequestReceived---------------";
}
...
void Widget::on_viewPersonalHtmlButton_clicked()
{
    qDebug() << " this is debug print start";
    const QString title = tr("Please enter a new password.");

    ViewPersonalHtmlDialog* dialog = new ViewPersonalHtmlDialog(title, QString{}, nullptr);
    if (dialog->exec() == QDialog::Rejected) {
        return;
    }
    qDebug() << " this is debug print end";
}


void Widget::on_viewPersonalHtmlButton_customContextMenuRequested(const QPoint &pos)
{
